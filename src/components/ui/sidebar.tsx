  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'relative h-dvh w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear pointer-events-none',
        ...
        <div
          className={cn(
            'fixed inset-y-0 z-20 hidden h-dvh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex',
            side === 'left'
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ...
      className={cn(
        'relative flex min-h-dvh flex-1 flex-col bg-background z-10',
