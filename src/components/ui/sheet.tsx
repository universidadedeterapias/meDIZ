...
>(({ side = "right", className, children, ...props }, ref) => {
  ...
  const hasVisibleTitle = childrenArray.some((child: React.ReactNode) => {
    ...
    // Verifica se é SheetHeader
    if (child.type === SheetHeader) {
      const props = child.props as React.ComponentProps<typeof SheetHeader>
    ...
    // Verifica se é diretamente SheetTitle
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        {...props}
      >
        {/* Garante SheetTitle para acessibilidade se não houver um visível */}
        {!hasVisibleTitle && (
