...
const agentStyles: Record<AgentId, { card: string; icon: string }> = {
  body: {
    card: 'from-white via-violet-50/80 to-fuchsia-50/70 dark:from-zinc-900 dark:via-violet-950/45 dark:to-fuchsia-950/25',
    icon: 'bg-gradient-to-br from-violet-100 to-fuchsia-100 text-violet-700 dark:from-violet-500/25 dark:to-fuchsia-500/20 dark:text-violet-200'
  },
  home: {
    card: 'from-white via-sky-50/80 to-cyan-50/70 dark:from-zinc-900 dark:via-sky-950/45 dark:to-cyan-950/25',
    icon: 'bg-gradient-to-br from-sky-100 to-cyan-100 text-sky-700 dark:from-sky-500/25 dark:to-cyan-500/20 dark:text-sky-200'
  },
  pet: {
    card: 'from-white via-amber-50/80 to-orange-50/70 dark:from-zinc-900 dark:via-amber-950/35 dark:to-orange-950/25',
...
export function ChatHomeExperience({
  ...
  return (
    <section className="mx-auto flex w-full max-w-5xl flex-col px-4 pb-12 pt-7 sm:px-7 sm:pb-16 sm:pt-12">
      <div className="relative isolate overflow-hidden rounded-[2rem] bg-gradient-to-br from-white via-violet-50/90 to-fuchsia-100/60 px-6 py-7 shadow-2xl shadow-violet-950/10 dark:from-zinc-900 dark:via-violet-950/70 dark:to-fuchsia-950/40 sm:px-9 sm:py-9">
        <div className="pointer-events-none absolute -right-12 -top-20 -z-10 size-56 rounded-full bg-gradient-to-br from-violet-300/40 to-fuchsia-300/20 blur-3xl dark:from-violet-500/20 dark:to-fuchsia-500/10" />
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedIntent === intent.id
                    ? 'bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/25'
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  selected && 'from-violet-600 via-purple-600 to-fuchsia-600 text-white shadow-2xl shadow-violet-500/30 dark:from-violet-600 dark:via-purple-700 dark:to-fuchsia-700'
                )}
              >
                <span
                  className={cn(
